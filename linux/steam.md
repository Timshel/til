...
```bash
export STEAM_COMPAT_DATA_PATH=~/.var/app/com.valvesoftware.Steam/.local/share/Steam/steamapps/compatdata
export STEAM_COMPAT_CLIENT_INSTALL_PATH=~/.local/share/Steam
cd /media/Games/flatpak-steam-library/SteamLibrary/steamapps/ommon/ELDEN\ RING/Game
